@interface AWEPadSkyLightTopBarViewModel : NSObject
@property (nonatomic) <AWESkyLightContainerConfigProtocol> config;
@property (nonatomic) AWEPadSkyLightTopBarViewController topBarView;
...
- (void)updateNewSectionWithOldSectionData:oldUpdateError:completion:;
- (BOOL)isSkyLightStatusChanged;
- (void)setIsSkyLightStatusChanged:;
- (void)setConfig:;
- (double)topBarHeight;
- (id)capsuleView;
- (id)initWithConfig:;
