@interface AWEECOMIMOpenWorkCardModel : AWEECOMIMBaseCardModel
...
@property (nonatomic) NSString logisticsCompany;
@property (nonatomic) NSString logisticsNum;
@property (nonatomic) NSArray tipsList;
...
- (void)setLogisticsCompany:;
- (void)setLogisticsNum:;
- (void)setTipsList:;
- (id)logisticsNum;
- (id)logisticsCompany;
- (id)tipsList;
