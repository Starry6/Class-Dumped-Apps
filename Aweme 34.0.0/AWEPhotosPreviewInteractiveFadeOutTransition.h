@interface AWEPhotosPreviewInteractiveFadeOutTransition : NSObject
...
@property (nonatomic) UIViewController<AWEPhotosPreviewFadeOutTransitionContextProvider> fromCP;
@property (nonatomic) UIViewController<AWEPhotosPreviewFadeInTransitionContextProvider> toCP;
