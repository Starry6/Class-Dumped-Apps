@interface AWEGrouponTaskServiceImpl : NSObject
@property (nonatomic) AWEGrouponTaskCenter taskCenter;
@property (nonatomic) AWEGrouponTaskCommonContext commonContext;
@property (nonatomic) AWEGrouponTaskStateManager stateManager;
