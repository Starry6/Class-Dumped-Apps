@interface AWEIMTaskPlatformDetailCardDetailActivityCellHeaderView : UIView
...
@property (nonatomic) UILabel cardDescription;
@property (nonatomic) UIImageView cardContentImageView;
...
- (id)cardTagLabel;
- (void)setCardContentImageView:;
- (id)cardContentImageView;
