@interface AWEFriendsCameraCustomization : NSObject
...
- (id)ratioStatusItem;
- (id)customTransition;
- (void)configAlbumWithAlbumPageConfig:;
...
- (void)configRecordAlbumWithScenarioConfig:;
...
- (void)configEditOtherWithScenarioConfig:;
...
- (void)configPublishPOIWithScenarioConfig:;
