...
@property (nonatomic) AWETeenImageAlbumImagePickerSelectIndicator selectIndicator;
@property (nonatomic) <AWETeenImageAlbumImagePickerCollectionViewCellDelegate> delegate;
