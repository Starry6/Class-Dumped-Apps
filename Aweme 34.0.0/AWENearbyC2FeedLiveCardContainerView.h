@interface AWENearbyC2FeedLiveCardContainerView : UIView
...
@property (nonatomic) AWENearbyFeedLiveExperimentView experimentView;
@property (nonatomic) AWENearbyC2FeedLiveLargeCardProductView productCardView;
