@interface AWEIMShareAndForwardEntertainmentCommentShareImpl : NSObject
@property (nonatomic) AWEIMEntertainmentCommentShareModel commentShareModel;
...
- (id)shareMessage;
- (id)commentShareModel;
- (void)setCommentShareModel:;
