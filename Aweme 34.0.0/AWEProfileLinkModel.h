...
@property (nonatomic) AWEProfileSmartPhoneListModel cacheSmartPhoneListModel;
@property (nonatomic) AWEProfileOpenTimeModel cacheOpenTimeModel;
...
- (void)setCacheSmartPhoneListModel:;
- (long long)linkType;
- (id)content;
- (void)setAction:;
- (id)action;
