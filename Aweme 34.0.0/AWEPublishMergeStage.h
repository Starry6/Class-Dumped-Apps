@interface AWEPublishMergeStage : AWEPublishBaseMergeStage
...
- (void)p_saveDraftWithCompletion:;
- (void)updateMergeImageResultWithImage:;
- (void)addTimeToMinDurationForMainTrack:;
- (BOOL)lessThanMinDurationWithDstDuration:;
- (void)p_callbackWithStatus:userInfo:;
- (void)configPublishExceptionJSONValidWithParams:;
- (void)trackError:action:fileSize:encodeDuration:transcodeParam:;
...
+ (BOOL)shouldEnableUploadDirectly:;
@end
