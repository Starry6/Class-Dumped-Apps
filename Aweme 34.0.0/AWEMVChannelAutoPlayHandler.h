@interface AWEMVChannelAutoPlayHandler : NSObject
@property (nonatomic) <AWEMVChannelAutoPlayContainerProtocol> container;
@property (nonatomic) AWEMVChannelPageContext context;
@property (nonatomic) UIView<AWEMVChannelAutoPlayCardProtocol> currentActiveView;
@property (nonatomic) {CGRect={CGPoint=dd}{CGSize=dd}} activeRect;
@property (nonatomic) {CGRect={CGPoint=dd}{CGSize=dd}} activeRectForSingle;
@property (nonatomic) BOOL isActive;
@property (nonatomic) NSMutableDictionary rulePlugins;
@property (nonatomic) UIView<AWEMVChannelAutoPlayCardProtocol> currentTransitionActiveView;
...
@property (nonatomic) AWEMVChannelAutoPlayHandler superHandler;
...
- (id)__calculateActiveRectForSingle;
- (void)setActiveRectForSingle:;
- (id)activeRectForSingle;
- (id)__findFirstView:;
- (void)prerenderFirstCardIfNeeded;
- (void)setContainer:;
- (id)container;
- (void)becomeActive;
