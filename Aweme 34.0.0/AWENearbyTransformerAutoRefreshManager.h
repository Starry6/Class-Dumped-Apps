...
@property (nonatomic) AWENearbyDynamicEventSubscriber transformerRefreshSubscriber;
@property (nonatomic) AWENearbyDynamicEventSubscriber transformerShouldRefreshSubcriber;
