...
@property (nonatomic) AWELifeFeedsLoadMoreComponentView loadMoreComponentView;
@property (nonatomic) AWELifeFeedsLoadmorePlugin loadmorePlugin;
@property (nonatomic) AWENearbyGrouponTabLoadMoreFooter noMoreStyle;
