@interface AWEIMShareAndForwardChapterImpl : NSObject
@property (nonatomic) AWEIMChapterMessageModel chapterShareModel;
...
- (id)shareMessage;
- (id)chapterShareModel;
- (void)setChapterShareModel:;
