@interface AWEFriendsImpl.AlbumPageContext : AWEPageContext
...
- (void)setIsPinchZoomable:;
- (void)setNeedMoveToCenterWhenMagnify:;
- (id)init;
- (id)delegate;
- (void)setIsMuted:;
- (void).cxx_destruct;
