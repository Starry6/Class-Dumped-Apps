@interface AWEIMActionInfoModel : IESIMBaseApiModel
@property (nonatomic) NSInteger type;
@property (nonatomic) NSInteger platform;
@property (nonatomic) NSString schema;
@property (nonatomic) NSDictionary extData;
@property (nonatomic) BOOL isV2;
@property (nonatomic) <IESIMDynamicPatchProtocol> dynamicPatchModel;
@property (nonatomic) <IESIMActionInfoUIInfoProtocol> uiInfo;
