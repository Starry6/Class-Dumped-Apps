@interface AWEGrouponForwardTabDYHandler : NSObject
...
@property (nonatomic) AWEGrouponResourceResponse lastResource;
@property (nonatomic) AWEGrouponLifeTabNoticeResopnse lastNoticeRsp;
