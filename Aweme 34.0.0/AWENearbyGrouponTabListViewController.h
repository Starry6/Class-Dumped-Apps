@interface AWENearbyGrouponTabListViewController : UIViewController
@property (nonatomic) AWENearbyPageContext pageContext;
@property (nonatomic) AWENearbyGrouponSegmentViewController segmentViewController;
@property (nonatomic) UIViewController<AWENearbyGrouponTabPageProtocol> currentPageVC;
@property (nonatomic) NSMutableArray tableArray;
@property (nonatomic) NSMutableDictionary tableDict;
@property (nonatomic) UIScrollView pageScrollView;
@property (nonatomic) AWENearbyGrouponTabListViewModel viewModel;
