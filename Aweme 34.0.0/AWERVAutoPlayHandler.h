@interface AWERVAutoPlayHandler : NSObject
@property (nonatomic) <AWERVAutoPlayContainerProtocol> container;
@property (nonatomic) UIView<AWERVAutoPlayCardProtocol> currentActiveView;
@property (nonatomic) {CGRect={CGPoint=dd}{CGSize=dd}} activeRect;
@property (nonatomic) BOOL isActive;
@property (nonatomic) NSMutableDictionary rulePlugins;
@property (nonatomic) UIView<AWERVAutoPlayCardProtocol> currentTransitionActiveView;
...
@property (nonatomic) AWERVAutoPlayHandler superHandler;
