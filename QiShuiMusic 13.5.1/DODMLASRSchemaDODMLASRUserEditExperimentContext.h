...
@property (nonatomic) DODMLASRSchemaDODMLASRUserEditExperimentStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) DODMLASRSchemaDODMLASRUserEditExperimentEnded ended;
