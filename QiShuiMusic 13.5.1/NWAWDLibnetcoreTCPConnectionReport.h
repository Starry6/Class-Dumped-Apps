...
@property (nonatomic) NWAWDLibnetcoreConnectionStatisticsReport connectionStatisticsReport;
@property (nonatomic) BOOL hasCellularFallbackReport;
@property (nonatomic) NWAWDLibnetcoreCellularFallbackReport cellularFallbackReport;
