...
- (id)multipartFormRequestWithMethod:URLString:parameters:constructingBodyWithBlock:;
...
- (id)requestWithMethod:URLString:parameters:;
- (id)requestWithMultipartFormRequest:writingStreamContentsToFile:completionHandler:;
- (void)setAuthorizationHeaderFieldWithToken:;
- (void)setAuthorizationHeaderFieldWithUsername:password:;
