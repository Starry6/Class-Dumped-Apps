...
@property (nonatomic) NSInteger itemsAlreadyPresentCount;
@property (nonatomic) BOOL hasItemsPartiallyPresentCount;
@property (nonatomic) NSInteger itemsPartiallyPresentCount;
@property (nonatomic) BOOL hasItemsNotPresentCount;
@property (nonatomic) NSInteger itemsNotPresentCount;
@property (nonatomic) BOOL hasChunksUploaded;
@property (nonatomic) NSInteger chunksUploaded;
@property (nonatomic) NSMutableArray chunkingInfos;
...
- (void)setItemsAlreadyPresentCount:;
- (void)setHasItemsAlreadyPresentCount:;
- (BOOL)hasItemsAlreadyPresentCount;
- (void)setItemsPartiallyPresentCount:;
- (void)setHasItemsPartiallyPresentCount:;
- (BOOL)hasItemsPartiallyPresentCount;
- (void)setItemsNotPresentCount:;
- (void)setHasItemsNotPresentCount:;
- (BOOL)hasItemsNotPresentCount;
- (void)setChunksUploaded:;
- (void)setHasChunksUploaded:;
- (BOOL)hasChunksUploaded;
- (void)clearChunkingInfos;
- (void)addChunkingInfos:;
- (unsigned long long)chunkingInfosCount;
- (id)chunkingInfosAtIndex:;
- (int)itemsAlreadyPresentCount;
- (int)itemsPartiallyPresentCount;
- (int)itemsNotPresentCount;
- (int)chunksUploaded;
- (id)chunkingInfos;
- (void)setChunkingInfos:;
+ (Class)errorType;
