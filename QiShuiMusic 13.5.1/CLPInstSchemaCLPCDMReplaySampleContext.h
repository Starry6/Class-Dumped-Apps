...
@property (nonatomic) CLPInstSchemaCLPCDMReplaySampleStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) CLPInstSchemaCLPCDMReplaySampleEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) CLPInstSchemaCLPCDMReplaySampleFailed failed;
