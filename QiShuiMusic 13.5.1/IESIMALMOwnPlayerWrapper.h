@interface IESIMALMOwnPlayerWrapper : NSObject
...
@property (nonatomic) IESIMALMOwnPlayerDelegateWrapper delegateWrapper;
...
@property (nonatomic) @? periodicTimeObserverBlock;
...
- (void)setPToken:;
- (void)setPeriodicTimeObserverBlock:;
- (void)setPlayAuth:;
- (void)setPlayByRestored:;
- (void)setPlayOnceWithURLs:;
...
+ (void)setPlayerMemoryOptimizeEnable:;
