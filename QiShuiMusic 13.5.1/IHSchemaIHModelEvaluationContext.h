...
@property (nonatomic) IHSchemaIHModelEvaluationStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) IHSchemaIHModelEvaluationEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) IHSchemaIHModelEvaluationFailed failed;
