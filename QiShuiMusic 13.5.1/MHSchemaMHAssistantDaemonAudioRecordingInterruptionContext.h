...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioRecordingInterruptionStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioRecordingInterruptionEnded ended;
