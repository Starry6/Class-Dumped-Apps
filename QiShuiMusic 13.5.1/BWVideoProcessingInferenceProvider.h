...
- (id)initWithType:analysisType:executionTarget:schedulerPriority:preventionReasons:resourceProvider:;
- (id)bindVideoInputFromAttachedMediaUsingKey:preparedByAttachedMediaKey:withVideoFormatProvider:;
- (id)bindOutputMetadataKeys:;
@end
