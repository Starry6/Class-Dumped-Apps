...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioRecordingFirstBufferStart startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioRecordinFirstBufferReceipt ended;
