...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioRecordingStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioRecordingEnded ended;
