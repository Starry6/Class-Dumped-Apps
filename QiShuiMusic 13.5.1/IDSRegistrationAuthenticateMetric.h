@interface IDSRegistrationAuthenticateMetric : NSObject
@property (nonatomic) NSString guid;
@property (nonatomic) BOOL success;
@property (nonatomic) I connectionType;
@property (nonatomic) I resultCode;
@property (nonatomic) I registrationError;
@property (nonatomic) BOOL isPhoneUser;
@property (nonatomic) BOOL isDSUser;
...
- (id)URLError;
- (id)initWithGuid:success:connectionType:resultCode:registrationError:isPhoneUser:isDSUser:genericError:URLError:POSIXError:;
- (BOOL)isPhoneUser;
- (BOOL)isDSUser;
@end
