...
@property (nonatomic) CTCarrierSpaceUsagePlanItemData dataUsage;
@property (nonatomic) CTCarrierSpaceUsagePlanItemMessages messages;
@property (nonatomic) CTCarrierSpaceUsagePlanItemVoice voice;
