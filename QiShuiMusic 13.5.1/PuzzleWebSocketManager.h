@interface PuzzleWebSocketManager : NSObject
@property (nonatomic) BDXThreadSafeDictionary socketTaskIDsForContainer;
@property (nonatomic) BDXThreadSafeDictionary socketTaskDict;
