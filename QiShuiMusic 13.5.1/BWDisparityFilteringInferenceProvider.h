@interface BWDisparityFilteringInferenceProvider : NSObject
...
- (id)initWithDisparityInputRequirement:disparityOutputRequirement:resourceProvider:configuration:isPreprocessing:;
@end
