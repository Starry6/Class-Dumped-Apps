@interface IDSRegistrationOperationGetDependentRegistrationsMetric : NSObject
...
- (id)URLError;
- (id)initWithGuid:success:connectionType:resultCode:registrationType:genericError:URLError:POSIXError:;
@end
