...
@property (nonatomic) NLXSchemaCDMServiceStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) NLXSchemaCDMServiceEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) NLXSchemaCDMServiceFailed failed;
