...
@property (nonatomic) <AFURLResponseSerialization> responseSerializer;
...
- (void)taskDidSuspend:;
- (void)addDelegateForDataTask:completionHandler:;
...
- (id)uploadTaskWithRequest:fromData:progress:completionHandler:;
- (id)uploadTaskWithRequest:fromFile:progress:completionHandler:;
