...
@property (nonatomic) POMMESSchemaPOMMESOnDeviceIndexSearchStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) POMMESSchemaPOMMESOnDeviceIndexSearchEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) POMMESSchemaPOMMESOnDeviceIndexSearchFailed failed;
