...
@property (nonatomic) INFERENCESchemaINFERENCEResolutionRequestStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) INFERENCESchemaINFERENCEResolutionRequestEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) INFERENCESchemaINFERENCEResolutionRequestFailed failed;
