...
@property (nonatomic) DODMLASRSchemaDODMLASRPersonalizationExperimentStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) DODMLASRSchemaDODMLASRPersonalizationExperimentEnded ended;
