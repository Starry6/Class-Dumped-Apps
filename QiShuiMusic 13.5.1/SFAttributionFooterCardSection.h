...
@property (nonatomic) SFRichText leadingAttribution;
@property (nonatomic) SFPunchout leadingAttributionPunchout;
@property (nonatomic) SFRichText trailingAttribution;
@property (nonatomic) SFPunchout trailingAttributionPunchout;
...
- (void)setLeadingAttribution:;
- (id)leadingAttributionPunchout;
- (void)setLeadingAttributionPunchout:;
- (id)trailingAttribution;
- (void)setTrailingAttribution:;
- (id)trailingAttributionPunchout;
- (void)setTrailingAttributionPunchout:;
