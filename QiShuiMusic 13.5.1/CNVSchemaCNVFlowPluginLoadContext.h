...
@property (nonatomic) CNVSchemaCNVFlowPluginLoadContextStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) CNVSchemaCNVFlowPluginLoadContextEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) CNVSchemaCNVFlowPluginLoadContextFailed failed;
