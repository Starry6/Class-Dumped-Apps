...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioStartRecordingStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioStartRecordingEnded ended;
