...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioSessionSetInactiveStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioSessionSetInactiveEnded ended;
