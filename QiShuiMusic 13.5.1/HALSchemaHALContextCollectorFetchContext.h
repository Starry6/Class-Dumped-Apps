...
@property (nonatomic) HALSchemaHALContextCollectorFetchStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) HALSchemaHALContextCollectorFetchEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) HALSchemaHALContextCollectorFetchFailed failed;
