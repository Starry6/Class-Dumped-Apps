@interface BMSafariPageViewEvent : NSObject
...
- (id)jsonDict;
- (BOOL)isEqual:;
- (id)initWithUniqueId:domainId:absoluteTimestamp:title:content:contentIsReaderText:url:contentProtection:;
- (id)initWithUniqueId:domainId:absoluteTimestamp:title:content:contentIsReaderText:url:;
