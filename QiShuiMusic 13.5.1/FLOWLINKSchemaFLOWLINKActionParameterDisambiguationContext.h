...
@property (nonatomic) FLOWLINKSchemaFLOWLINKActionParameterDisambiguationStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) FLOWLINKSchemaFLOWLINKActionParameterDisambiguationEnded ended;
