...
@property (nonatomic) FLOWLINKSchemaFLOWLINKActionPromptForValueStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) FLOWLINKSchemaFLOWLINKActionPromptForValueEnded ended;
