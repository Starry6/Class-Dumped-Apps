...
@property (nonatomic) FLOWLINKSchemaFLOWLINKActionConfirmationStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) FLOWLINKSchemaFLOWLINKActionConfirmationEnded ended;
