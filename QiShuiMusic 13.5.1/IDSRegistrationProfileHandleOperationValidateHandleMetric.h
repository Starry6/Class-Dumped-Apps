@interface IDSRegistrationProfileHandleOperationValidateHandleMetric : NSObject
...
- (id)URLError;
- (id)initWithGuid:success:connectionType:resultCode:registrationError:vettingStatus:genericError:URLError:POSIXError:;
