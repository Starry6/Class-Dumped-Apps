...
@property (nonatomic) MTSchemaMTBatchRequestStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MTSchemaMTBatchRequestEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) MTSchemaMTBatchRequestFailed failed;
@property (nonatomic) BOOL hasFailed;
@property (nonatomic) MTSchemaMTBatchRequestCancelled cancelled;
