...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioTwoShotTransitionStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioTwoShotTransitionEnded ended;
