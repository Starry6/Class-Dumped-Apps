...
@property (nonatomic) ORCHSchemaORCHServerFallbackInitiated startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) ORCHSchemaORCHServerFallbackResponseReceived ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) ORCHSchemaORCHServerFallbackFailed failed;
