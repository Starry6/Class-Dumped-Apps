...
- (BOOL)shouldHandleContactItemsFromSession:;
- (BOOL)canLoadContactObjectsFromSession:;
- (void)addContactItemsToTargetViewFromSession:;
- (void)addDroppedContacts:toTargetView:forSession:;
- (void)handleDropOfContactItemProviders:;
- (id)emailRecipientForContact:;
- (id)unifiedEmailRecipientForContact:;
- (unsigned long long)composeAddressKind:;
+ (id)os_log;
@end
