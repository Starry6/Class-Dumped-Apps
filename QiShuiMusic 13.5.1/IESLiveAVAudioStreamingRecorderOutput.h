@interface IESLiveAVAudioStreamingRecorderOutput : NSObject
...
- (void)copyEncoderCookieToFile:error:;
- (void)didReceiveAudio:;
- (BOOL)openAudioFile;
- (BOOL)readySaveAudioToFile;
- (void)setConvertSettingDidSet:;
- (void)setConvertSettingReady:;
- (void)setReadySaveAudioToFile:;
