...
@property (nonatomic) INDateComponentsRange previousValue;
@property (nonatomic) INDateComponentsRange currentValue;
@property (nonatomic) q code;
@property (nonatomic) INDateComponentsRange oldValue;
@property (nonatomic) INDateComponentsRange updatedValue;
