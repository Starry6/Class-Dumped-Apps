...
@property (nonatomic) NSDate requestFireDate;
...
- (id)initWithTarget:selector:delay:maximumDelay:callOnMainThread:;
- (id)initWithTarget:selector:delay:waitToFireUntilRequestsStop:callOnMainThread:;
- (void)setCallOnMainThread:;
- (id)initWithTarget:selector:delay:maximumDelay:waitToFireUntilRequestsStop:callOnMainThread:;
@end
