...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioFetchRouteStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioFetchRouteEnded ended;
