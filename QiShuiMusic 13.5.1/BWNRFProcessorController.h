@interface BWNRFProcessorController : BWStillImageProcessorController
...
- (void)inputReceivedProcessedRawErrorRecoveryFrame:;
- (void)processor:didSelectProgressiveFusionReferenceFrameIndex:;
@end
