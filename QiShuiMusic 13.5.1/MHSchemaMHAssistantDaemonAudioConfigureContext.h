...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioConfigureStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioConfigureEnded ended;
