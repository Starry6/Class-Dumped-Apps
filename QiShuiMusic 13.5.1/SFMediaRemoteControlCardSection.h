...
@property (nonatomic) NSString playbackRouteUniqueIdentifier;
@property (nonatomic) BOOL playbackRouteUniqueIdentifierIsEncrypted;
@property (nonatomic) NSString playbackBundleIdentifier;
...
- (void)setPlaybackRouteUniqueIdentifier:;
- (BOOL)playbackRouteUniqueIdentifierIsEncrypted;
- (void)setPlaybackRouteUniqueIdentifierIsEncrypted:;
- (id)playbackBundleIdentifier;
- (void)setPlaybackBundleIdentifier:;
