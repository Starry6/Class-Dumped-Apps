...
@property (nonatomic) HALSchemaHALForceFetchStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) HALSchemaHALForceFetchEnded ended;
@property (nonatomic) BOOL hasEnded;
@property (nonatomic) HALSchemaHALForceFetchFailed failed;
