...
@property (nonatomic) ^{CSJLOT_Subpath=id{CGPoint=dd}{CGPoint=dd}{CGPoint=dd}^{CSJLOT_Subpath}} headSubpath;
...
- (void)CSJLOT_addCurveToPoint:controlPoint1:controlPoint2:;
- (void)CSJLOT_applyTransform:;
- (void)CSJLOT_closePath;
- (void)CSJLOT_enumeratePath:elementsUsingBlock:;
- (void)CSJLOT_addLineToPoint:;
- (void)CSJLOT_appendPath:;
- (void)CSJLOT_moveToPoint:;
