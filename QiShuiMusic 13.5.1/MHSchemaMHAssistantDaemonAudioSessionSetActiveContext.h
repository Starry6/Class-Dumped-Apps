...
@property (nonatomic) MHSchemaMHAssistantDaemonAudioSessionSetActiveStarted startedOrChanged;
@property (nonatomic) BOOL hasStartedOrChanged;
@property (nonatomic) MHSchemaMHAssistantDaemonAudioSessionSetActiveEnded ended;
